...
export default function NotificationPageComponent() {
  ...
  <div class="alert alert-${notificationType} ${notificationDismissible ? 'alert-dismissible' : ''} fade ${notificationShow}" role="alert">
      <h4 className="alert-heading">${notificationHeading}</h4>
      <p>${notificationMessage}</p>
    ${notificationDismissible ? '<button type="button" className="btn-close" aria-label="Close" data-dismiss="alert"></button>' : ''}
  </div>`;
